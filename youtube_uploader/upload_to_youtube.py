...
if __name__ == '__main__':
    ...
    title = f"{today} [글로벌뉴스_100초요약] 이 포스팅은 쿠팡파트너스 활동으로 일정보수를 받습니다"
    description = "100초요약_오늘의 글로벌뉴스 만나보세요. AI가 요약/제작합니다.이 포스팅은 쿠팡파트너스 활동으로 일정보수를 받습니다"
    tags = ["글로벌뉴스", "뉴스요약", "세계뉴스", "뉴스", "카드뉴스","AI"]
